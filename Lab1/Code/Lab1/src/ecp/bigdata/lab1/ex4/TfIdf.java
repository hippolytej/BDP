...
public class TfIdf extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
      ...
      if (fs.exists(outputPath)) {
        ...
        FileInputFormat.addInputPath(job2, new Path("temp1/part-r-00000"));
     ...
     // docs per word
        ...
        FileInputFormat.addInputPath(job3, new Path("temp2/part-r-00000"));
    ...
    public static void main(String[] args) throws Exception {
        TfIdf WCDriver = new TfIdf();
        int res = ToolRunner.run(WCDriver, args);
        System.exit(res);
    }
}
