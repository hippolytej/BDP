	...
	public static void main(String[] args) throws IOException {
		...
		try{
			...
			while (line !=null){
				...
				String[] n_pr = line.split(";");
				String node = n_pr[0];
				double pr = Double.parseDouble(n_pr[1]);
				
				unsorted.put(node, pr);
				
				line = br.readLine();
			}
			
			Map<String, Double> sorted = SortPRResults.sortByValue( unsorted);
